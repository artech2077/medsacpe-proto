...
function WeightBasedLiquidMedicationCalculatorPreview() {
  return (
    <div className="max-w-[460px] overflow-hidden rounded-[16px] border border-[#d5dfec] bg-white p-5">
...
export const galleryRegistry: GalleryEntry[] = [
  ...
  },
  {
    category: "input",
    description:
      "Step-by-step, task-scoped weight-based liquid medication dosing calculator rendered inside the shared responsive feature panel.",
    id: "weight-based-liquid-medication-calculator",
    preview: WeightBasedLiquidMedicationCalculatorPreview,
    sourcePath: "src/components/medscape/ai-response/weight-based-liquid-medication-calculator.tsx",
    title: "WeightBasedLiquidMedicationCalculator",
    usageNotes: [
      "Use inside ResponsiveFeaturePanel to keep the calculator in the current task rather than navigating to a new browser tab.",
      "The calculator accepts weight, daily dosage, frequency, and liquid concentration; all inputs remain local to its open panel.",
    ],
  },
  {
    category: "content",
